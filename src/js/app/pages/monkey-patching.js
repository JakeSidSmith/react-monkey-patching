...
export default class MonkeyPatching extends PatchableComponent {
  render () {
    return (
      <div>
        <h2>
        ...
        <p>
          The term monkey patch seems to have come from an earlier term, guerrilla patch, which referred to
        ...
        <ul>
          ...
          <li>
            Distribute security or behavioural fixes that live alongside the original source code (an example of
            this would be distributing the fix as a plugin for the Ruby on Rails platform).
          </li>
        </ul>
      </div>
    );

  ...
  render () {
    return (
      <div>
        ...
        <p>
          Hello! My name is Jake, and today I'm going to show you some totally not hacks at all, really not hacks, believe me, I promise, awesome monkey patching of React.
        </p>
        <h2>
